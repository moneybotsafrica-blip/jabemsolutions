# Generated by Django 5.0.6 on 2026-09-19 11:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='shop_slot',
            field=models.CharField(blank=True, choices=[('', '— Not in a shop section —'), ('quick_sale', 'Quick Sale Offers'), ('whats_new', "What's New"), ('new_arrival', 'New Arrivals')], default='', help_text='Show this product in a themed section on the shop page.', max_length=12, verbose_name='Shop section'),
        ),
